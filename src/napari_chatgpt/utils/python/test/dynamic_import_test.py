...
from napari_chatgpt.utils.python.dynamic_import import dynamic_import, execute_as_module
...
def test_execute_as_module():
    result = execute_as_module(
        ___some_numba_stuff, name="some_numba_stuff", external_var=1
    )
